...
public abstract class DataNode<VH extends DataViewHolder<?>> {
    ...
    protected boolean alive() {
        ...
        if (currentBinding == null || currentBinding.itemView.getTag(TagKey.DataNode.Key) != DataNode.this) {
            return false;
        }
        return true;
    }
    ...
    public final Binding<ColorConfig<?>> Color = emptyBinding(TagKey.DataNodeColor);
